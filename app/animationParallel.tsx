...
import { View, Animated, Easing, StyleSheet, Text, TouchableHighlight } from 'react-native';

class RNAnimationParallel extends React.Component {
...
export default RNAnimationParallel